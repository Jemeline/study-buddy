...
function HelpCenterDashboard() {
    ...
    return (
        <Paper style={{overflow:'auto',height:'225px',width:"100%",display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'column',cursor:'pointer'}} onClick={()=>history.push('/student-help')}>
                ...
                <p style={{marginBottom:'2px',marginTop:'0px',fontFamily: 'Garamond, serif',fontSize:'20px'}}><em>Need Help?</em></p>
                <h6 style={{marginBottom:'4px',marginTop:'0px',fontFamily: 'Garamond, serif',fontSize:'25px'}}>Study Buddy Help Center</h6>
        </Paper>
    );
}
